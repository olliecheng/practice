...
function DexamethasoneTest() {
  ...
  const handleSuppressionAssessment = () => {
    ...
    const isCorrect =
      suppressionAssessment.lowDoseSuppress ===
        correctPattern.lowDoseSuppress &&
      suppressionAssessment.highDoseSuppress ===
        correctPattern.highDoseSuppress;
  ...
  const getDiagnosisInfo = (diagnosis) => {
    const info = {
      ...
      "adrenal-cushing": {
        ...
        suppressionPattern:
          "Low dose: No suppression, High dose: No suppression",
        color: "red",
      },
      "ectopic-acth": {
    ...
    return (
      <div>
        <p className="text-gray-600 mb-8">
          Each case presents a patient with confirmed hypercortisolism and
          results from low and high dose dexamethasone suppression testing.
          Analyze the lab patterns to determine the source of excess cortisol.
        </p>
        <button
    ...
    <div class="text-left">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-700">
          {currentCase.patient.age}-year-old{" "}
          {currentCase.patient.gender.toLowerCase()} patient with biochemically
          confirmed hypercortisolism. Dexamethasone suppression testing
          performed to determine the source of excess cortisol production.
        </p>
      </div>
            ...
            <tbody>
              <tr>
                ...
                <td className="border border-gray-300 p-3 text-center">
                  {currentCase.labs.baselineCortisol} μg/dL
                </td>
              ...
              <tr className="bg-gray-25">
                ...
                <td className="border border-gray-300 p-3 text-center">
                  {currentCase.labs.baselineACTH} pg/mL
                </td>
                <td className="border border-gray-300 p-3 text-center text-gray-600">
                  10-60 pg/mL
                </td>
              ...
              <tr>
                <td className="border border-gray-300 p-3 font-medium">
                  Low Dose Dex Cortisol
                </td>
                <td className="border border-gray-300 p-3 text-center">
                  {currentCase.labs.lowDoseCortisol} μg/dL
                </td>
                <td className="border border-gray-300 p-3 text-center text-gray-600">
                  {currentStage === 1
                    ? `Baseline: ${currentCase.labs.baselineCortisol} μg/dL`
                    : "<5 μg/dL (normal suppression)"}
                </td>
              </tr>
              <tr className="bg-gray-25">
                <td className="border border-gray-300 p-3 font-medium">
                  High Dose Dex Cortisol
                </td>
                <td className="border border-gray-300 p-3 text-center">
                  {currentCase.labs.highDoseCortisol} μg/dL
                </td>
                <td className="border border-gray-300 p-3 text-center text-gray-600">
                  {currentStage === 1
                    ? `Baseline: ${currentCase.labs.baselineCortisol} μg/dL`
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 mb-6">
          Based on the dexamethasone suppression test results above, which doses
          effectively suppressed cortisol? (Suppression is typically defined as
        ...
        <div className="space-y-4">
          ...
          >
            <input
              ...
              onChange={() =>
                currentStage === 1 && handleSuppressionChange("lowDoseSuppress")
              }
            ...
            <div>
              ...
              <div className="text-sm text-gray-600">
                {currentCase.labs.lowDoseCortisol} μg/dL represents effective
                suppression from baseline ({currentCase.labs.baselineCortisol}{" "}
                μg/dL)
              </div>
            </div>
          </label>
          ...
          >
            <input
              ...
              onChange={() =>
                currentStage === 1 &&
                handleSuppressionChange("highDoseSuppress")
              }
              disabled={currentStage !== 1}
              className="mr-4 h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded disabled:opacity-50"
            />
            <div>
              <div className="font-medium">
                High dose dexamethasone suppresses cortisol
              </div>
              <div className="text-sm text-gray-600">
                {currentCase.labs.highDoseCortisol} μg/dL represents effective
                suppression from baseline ({currentCase.labs.baselineCortisol}{" "}
                μg/dL)
              </div>
            </div>
      ...
      {currentStage >= 2 && suppressionFeedback && (
        <div
          className={`p-4 rounded-lg border mb-8 text-center ${
        ...
        >
          ...
          {!suppressionFeedback.isCorrect && (
            <p className="text-sm">
              Correct answer:{" "}
              {suppressionFeedback.correctPattern.lowDoseSuppress
                ? "Low dose suppresses"
                : "Low dose does not suppress"}
              ,{" "}
              {suppressionFeedback.correctPattern.highDoseSuppress
                ? "High dose suppresses"
                : "High dose does not suppress"}
            </p>
          )}
        </div>
      )}
          ...
          >
            ...
            >
              ...
              >
                ...
                {getDiagnosisInfo(currentCase.diagnosis).suppressionPattern}
              </p>
            </div>
          </div>
