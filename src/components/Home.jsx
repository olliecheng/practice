    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed">
            Master parathyroid disorder diagnosis using calcium and PTH pattern recognition 
            with directional arrows to differentiate primary, secondary, tertiary, and hypoparathyroidism.
          </p>
          <div className="font-serif mt-4 text-blue-600 font-medium">
            Start Test →
          </div>
