      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed">
            Practice the diagnostic pathway for Cushing's syndrome using low and
            high dose dexamethasone suppression tests, including cortisol and
            ACTH interpretation.
          </p>
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed">
            Master parathyroid disorder diagnosis using calcium and PTH pattern
            recognition with directional arrows to differentiate primary,
